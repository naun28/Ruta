                ...
                <table class="footable table table-stripped toggle-arrow-tiny" >
                  <thead>
                    <tr>
                      ...
                      <th >Rendimiento</th>
                      <th >Destino(s)</th>
                      <th data-hide="all" >Fecha de salida</th>
                      <th data-hide="all" >Fecha de llegada</th>
                      ...
                      <th data-hide="all" >Viaticos</th>
                      <th data-hide="all" >Brigadista acompañante</th>
                      <th data-hide="all" >Viaticos</th>
                    ...
                    <?php
                      ...
                      while($row=mysqli_fetch_array($rs))
                      {
                        echo "<tr class='gradeX'>";
                          ...
                          echo "<td> <a href='#' class='btn btn-danger'>Imprimir</a></td>";
